-- ============================================
-- SIMPLE SMART-Barangay Database Setup
-- Uses EXACT original schema, no modifications
-- ============================================
...
-- ============================================
-- BASIC POLICIES (Simple and Working)
-- ============================================
...
-- INCIDENT_REPORTS policies - Simple version
...
CREATE POLICY "reports_select" ON incident_reports FOR SELECT USING (true); -- Simple: everyone can see all reports for now
...
-- ============================================
-- REALTIME (Skip if already exists)
-- ============================================
DO $$ 
BEGIN
...
-- SEED DATA
-- ============================================
INSERT INTO announcements (title, content, author_name, is_pinned, is_active) VALUES
  ('Welcome to SMART-Barangay', 'This system allows residents to report incidents and barangay officials to monitor and respond to them efficiently.', 'Barangay Admin', true, true),
  ('Emergency Hotline', 'For emergencies, please call 911 or the barangay emergency hotline. This system is for reporting and monitoring only.', 'Barangay Office', false, true)
ON CONFLICT DO NOTHING;

-- Success message
SELECT 'Basic database setup completed successfully! You can now create admin accounts.' as message;