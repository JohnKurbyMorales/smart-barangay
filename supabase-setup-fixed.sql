-- ============================================
-- COMPLETE SMART-Barangay Database Setup (FIXED)
...
CREATE POLICY "announcements_read_all" ON announcements FOR SELECT USING (is_active = true OR get_user_role() IN ('staff', 'admin'));
